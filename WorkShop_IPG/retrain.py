...
##  Imagens (samples dos exemplos tensorflow)
...
# caminho para pastas de imagens rotuladas
TRAINING_IMAGES_DIR = os.getcwd() + '/training_images'

TEST_IMAGES_DIR = os.getcwd() + "/test_images/"

# onde salvar o graph treinado
OUTPUT_GRAPH = os.getcwd() + '/' + 'retrained_graph.pb'

# onde salvar os graphs intermediários
INTERMEDIATE_OUTPUT_GRAPHS_DIR = os.getcwd() + '/intermediate_graph'

# quantos passos para armazenar graph intermediário, se "0" então não irá armazenar
INTERMEDIATE_STORE_FREQUENCY = 0

# onde salvar os rótulos do graph treinado
OUTPUT_LABELS = os.getcwd() + '/' + 'retrained_labels.txt'

# onde salvar logs de resumo do TensorBoard
TENSORBOARD_DIR = os.getcwd() + '/' + 'tensorboard_logs'

# quantas etapas de treino devem ser executadas antes de terminar
# NOTA: o padrão original do Google é 4000, use 4000 (ou possivelmente maior) para os resultados da classificação em produção
HOW_MANY_TRAINING_STEPS = 500

# quão grande é uma taxa de aprendizagem a ser usada ao treinar
LEARNING_RATE = 0.01

# qual porcentagem de imagens para usar como um conjunto de testes
TESTING_PERCENTAGE = 10

# qual porcentagem de imagens para usar como um conjunto de validação
VALIDATION_PERCENTAGE = 10

# com que frequência avaliar os resultados do treino
EVAL_STEP_INTERVAL = 10

# quantas imagens treinar de cada vez
TRAIN_BATCH_SIZE = 100

# Quantas imagens para testar. Este conjunto de teste é usado apenas uma vez para avaliar a precisão final do modelo após
# treinamento concluído. Um valor de -1 faz com que todo o conjunto de testes seja usado, o que leva a resultados mais estáveis ​​nas execuções.
TEST_BATCH_SIZE = -1

# Quantas imagens usar em um lote de avaliação. Esse conjunto de validação é usado com muito mais frequência do que o conjunto de testes e é um indicador antecipado de como
# preciso o modelo é durante o treinamento. Um valor de -1 faz com que todo o conjunto de validação seja usado, o que leva a
# resultados mais estáveis ​​nas iterações de treinamento, mas podem ser mais lentos em grandes conjuntos de treinamento.
VALIDATION_BATCH_SIZE = 100

# se deseja imprimir uma lista de todas as imagens de teste classificadas incorretamente
PRINT_MISCLASSIFIED_TEST_IMAGES = False

# Caminho para classify_image_graph_def.pb, imagenet_synset_to_human_label_map.txt e imagenet_2012_challenge_label_map_proto.pbtxt
MODEL_DIR = os.getcwd () + "/" + "model"

# Caminho para armazenar em cache os valores da camada de gargalo como arquivos
BOTTLENECK_DIR = os.getcwd () + '/' + 'bottleneck_data'

# o nome da camada de classificação de saída no gráfico reutilizado
FINAL_TENSOR_NAME = 'final_result'

# se deve virar aleatoriamente metade das imagens de treinamento horizontalmente
FLIP_LEFT_RIGHT = False

# uma porcentagem que determina quanto de uma margem para cortar aleatoriamente as imagens de treinamento
RANDOM_CROP = 0

# uma porcentagem que determina quanto aumentar aleatoriamente o tamanho das imagens de treinamento
RANDOM_SCALE = 0

# uma porcentagem que determina quanto multiplicar aleatoriamente os pixels de entrada da imagem de treinamento para cima ou para baixo
RANDOM_BRIGHTNESS = 0
